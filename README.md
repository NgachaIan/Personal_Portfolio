...
**Personal_Portfolio** is a responsive, pixel-perfect, and optimized web app for mobile view as per the Figma Design, template 3
...
```
git clone https://github.com/NgachaIan/Personal_Portfolio
```
...
- [ ] **Implement a desktop version as well**
